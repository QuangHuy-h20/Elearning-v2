  ...
  return (
    <div className="flex items-center">
      <NextLink href={`/course/update-course/${courseId}`}>
        <a className="bg-indigo-500 mr-3 text-white  text-xs px-3 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none ease-linear transition-all duration-150">
          <EditIcon />
        </a>
      </NextLink>
      <button
        onClick={() => onCourseDelete(courseId)}
